# E-commerce Bike Parts - QA Manual

Este proyecto consistió en la simulación de un E-commerce de repuestos de bicicletas. Mi rol principal fue **QA Engineer**, asegurando la calidad del producto desde las etapas iniciales.

### 🛠️ Tareas Realizadas:
* **Planificación de Pruebas**: Creación de planes de prueba para el flujo de compra y registro.
